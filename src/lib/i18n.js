...
const EN = {
  ...
  'Relativa': 'Relative',
  'Tu mejor marca dividida por tu peso corporal. El nivel solo aparece en los básicos.': 'Your best mark divided by your body weight. Levels only appear on the main lifts.',
  'Más fuerte para tu peso': 'Strongest for your weight',
  '{n}× para {level}': '{n}× for {level}',
  'mejor 1RM estimado': 'best estimated 1RM',
  'Ningún ejercicio coincide con': 'No exercise matches',
  'Novato': 'Novice',
  'Élite': 'Elite',
  'Series/sem': 'Sets/wk',
  'series/sem': 'sets/wk',
