  ...
  return (
    <Sheet title="Crear rutina" subtitle={`Personalizada para ${clientName}`} onClose={onClose}>
      ...
      <button
        ...
        {...pressProps(0.99)}
      >
        <span style={{ color: 'var(--c-accent)', fontSize: '11px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.04em' }}>
          {copiedFrom ? 'Elegir otra de mis rutinas' : 'Usar una de mis rutinas'}
        </span>
        <span aria-hidden="true" style={{ color: 'var(--c-accent)', fontSize: '13px', flexShrink: 0 }}>→</span>
      </button>
        ...
        <section className="fade-in" style={{ marginBottom: '28px', animationDelay: '60ms' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <button onClick={() => setModal('mine')} style={{ color: 'var(--c-accent)', fontSize: '10px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.06em' }}>+ De mis rutinas</button>
